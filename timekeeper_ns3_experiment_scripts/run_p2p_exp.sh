...
cd /home/kronos/ns-allinone-3.29/ns-3.29 && sudo ./waf --run "examples/timekeeper_experiments/simple_p2p_network --enableTimeKeeper=true --runTimeSecs=10 --nSimHostsperSwitch=1 --nSwitches=10 --numTracersperLXC=1 --nLXCsperSwitch=11 --logFolder=p2p_grpc_1100_emu_hosts_timekeeper_timeslice_100us"
