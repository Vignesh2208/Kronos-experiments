...
parser.add_argument('--isHTTP2', dest='isHTTP2', type=bool, default=True,
...
HTTP11_CLIENT_CMD = '/home/kronos/ns-allinone-3.29/ns-3.29/examples/vt_experiments/common/client_http11 {server_ip} {numTrials} {period} {numThreads}'
