...
#echo 'Running 480 LXCs HTTP2'
#cd /home/kronos/ns-allinone-3.29/ns-3.29/examples/vt_experiments/common/startup_cmds/campus_network && python generate_lxc_cmds.py --nServers=20 --nLXCsperSwitch=40 --nSwitches=12 --isHTTP2=1
#cd /home/kronos/ns-allinone-3.29/ns-3.29 && sudo ./waf --run "examples/kronos_experiments/campus_network --enableKronos=true --runTimeSecs=3 --nSimHostsperSwitch=1 --nLXCsperSwitch=40 --logFolder=campus_http2_480_LXCs_3secs"
