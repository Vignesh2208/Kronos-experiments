...
fig.add_trace(go.Scatter(
    ...
    name='HTTP2 60 Emulated, 2.4K Simulated Hosts',
...
fig.add_trace(go.Scatter(
    ...
    name='HTTP2 120 Emulated, 2.4K Simulated Hosts',
...
fig.add_trace(go.Scatter(
    ...
    name='HTTP1.1 60 Emulated, 2.4K Simulated Hosts',
    marker=dict(color='green', size=20, symbol="triangle-down-dot"),
    mode='markers',
        line=dict(
                color="blue",
                width=4.0,
...
fig.add_trace(go.Scatter(
    ...
    name='HTTP1.1 120 Emulated, 2.4K Simulated Hosts',
...
fig.update_layout(
    title=go.layout.Title(
        text="HTTP2 vs HTTP1.1 Request Completion Times",
	font=dict(
                family="Courier",
                size=30
            ),
