...
fig.update_layout(
    title=go.layout.Title(
        text="Cartpole PID Control with Virtual Time",
	font=dict(
                family="Courier",
                size=30
            ),
...
fig.update_xaxes(title_font=dict(size=30, family='Courier'), tickfont=dict(family='Courier', size=30), nticks=5, dtick=1)
fig.update_yaxes(title_font=dict(size=30, family='Courier'), tickfont=dict(family='Courier', size=30), nticks=5, dtick=1)
