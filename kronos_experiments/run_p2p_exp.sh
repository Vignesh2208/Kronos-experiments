...
cd /home/kronos/ns-allinone-3.29/ns-3.29 && sudo ./waf --run "examples/kronos_experiments/simple_p2p_network --enableKronos=true --runTimeSecs=5 --nSimHostsperSwitch=1 --nSwitches=10 --numTracersperLXC=10 --nLXCsperSwitch=10 --logFolder=p2p_grpc_1000_emu_hosts_kronos_type_2"
